...
import com.codewithprince.blog.services.FileService;
import com.codewithprince.blog.services.PostService;
...
public class PostController {
	...
	public ApiRespnse deletePost(@PathVariable Integer postId) {
		...
		return new ApiRespnse("Post is successfully deleted !!", true);
